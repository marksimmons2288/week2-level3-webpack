...
export function reverse(text) {
  // 1. splits the text into multiple individual (characters)- equates to numbers also
  // 2. reverse the position of each individual char
...
export function toKebabCase(text) {
  return text
    ...
    .join("-"); // joins the words with a hyphen 
}